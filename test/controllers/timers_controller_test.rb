...
class TimersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create timer" do
    assert_difference('Timer.count') do
      post timers_url, params: { timer: { description: @timer.description, job_id: @timer.job_id, time: @timer.time } }
    end
  ...
  test "should update timer" do
    patch timer_url(@timer), params: { timer: { description: @timer.description, job_id: @timer.job_id, time: @timer.time } }
